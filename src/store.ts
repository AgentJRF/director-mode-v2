...
export type ModalKind = null | 'interp' | 'ai' | 'ai-image' | 'ai-camera-prompt' | 'ai-video' | 'ai-review-image' | 'ai-review-video' | 'ai-light-match' | 'ai-light-prompt' | 'ai-light-env' | 'export';
